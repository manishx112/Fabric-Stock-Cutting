 ...
 *
 * `applied` tabhi true hota hai jab fixDates ON kiya jaye (Health drawer ka checkbox).
 * Default OFF — yaani numbers sheet ki likhi hui dd/mm/yyyy dates se hi bante hain.
 *
...
export function normalise(payload, fixDates = false) {
  ...
  src.forEach((s, i) => {
    ...
    out.push({
      ...
      /* flag = galti ka type (hamesha), applied = sudhaar sach me laga ya nahi */
      flag, applied: fixDates && !!better,
